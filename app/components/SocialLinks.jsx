export default function SocialLinks({ className = "" }) {
  return (
    <nav className={`social-links ${className}`.trim()} aria-label="Social media">
      <a className="social-glass" href="https://instagram.com/storieshouse.official" target="_blank" rel="noreferrer" aria-label="Stories House on Instagram" title="Instagram">
      ...
      <a className="social-links-pinterest social-glass" href="https://pin.it/3QoNDdx1U" target="_blank" rel="noreferrer" aria-label="Stories House on Pinterest" title="Pinterest">
