...
const DepthCarousel = ({
  ...
  const onCardClick = useCallback(
    index => {
      ...
      } else if (advanceOnCardClick) {
        navigateBy(1);
      }
    },
    [advanceOnCardClick, data, navigateBy, router]
  );
  ...
  useEffect(() => {
    layout(posRef.current);
  }, [layout, depth, spread, tilt, tiltDirection, visibleCards, falloff, blur, stackOffset, cardWidth, cardHeight, radius, count]);
